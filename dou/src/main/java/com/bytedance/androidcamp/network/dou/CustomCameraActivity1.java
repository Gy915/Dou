...
import com.bytedance.androidcamp.network.dou.api.IMiniDouyinService2;
import com.bytedance.androidcamp.network.dou.bean.PostVideoResponse;
...
public class CustomCameraActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSurfaceView = findViewById(R.id.img1);
        ...
        mBtn_change = findViewById(R.id.btn_facing1);
        mBtn_record =findViewById(R.id.btn_record1);
...
//                toast.show();
    ...
    private MultipartBody.Part getMultipartFromUri(String name, Uri uri) {
        ...
        File f = new File(ResourceUtils.getRealPath(CustomCameraActivity1.this, uri));
...
//        mBtn.setEnabled(false);
        ...
        Call<PostVideoResponse> call = retrofit.create(IMiniDouyinService2.class).postVideo(aImage,aVideo);
